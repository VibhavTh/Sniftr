/**
 * Wishlist collection grid page
 * Fetches from GET /collections?type=wishlist
 */
...
export default function WishlistPage() {
  ...
  useEffect(() => {
    const fetchCollection = async () => {
      ...
      setError(null)
      try {
        const data = await apiGet<CollectionResponse>('/collections?type=wishlist')
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-14 py-8 sm:py-12 lg:py-20">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-10">
          <h2 className="font-serif text-[28px] sm:text-[36px] lg:text-[42px] font-light text-neutral-900 mb-1 sm:mb-2 leading-tight">Wishlist</h2>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white border border-neutral-200 p-8 sm:p-12 lg:p-16 text-center">
              ...
              <p className="text-[14px] sm:text-[15px] font-light text-neutral-500 leading-relaxed mb-6 sm:mb-10 max-w-md mx-auto">
                Add fragrances to your wishlist from the detail view to keep track of scents you want to try
              </p>
